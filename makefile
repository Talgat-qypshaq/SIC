...
main: SIC.o SIC_Random.o SIC_Generate.o SIC_Rayleigh.o
	${NVCC} ${OPT} -o main SIC.o SIC_Random.o SIC_Generate.o SIC_Rayleigh.o
...
SIC: SIC.o SIC_Random.o SIC_Generate.o SIC_Rayleigh.o
	${NVCC} ${CUDAFLAGS} -o SIC SIC.o SIC_Random.o SIC_Generate.o SIC_Rayleigh.o -lcufft
